...
import {DeployDonorGlee} from "../../script/DeployDonorGlee.s.sol";
import {DonorGleeFund} from "../../src/DonorGleeFund.sol";
import {DonorGleeRaffle} from "../../src/DonorGleeRaffle.sol";
import {HelperConfig} from "../../script/HelperConfig.s.sol";

contract TestDonorGlee is Test {
    DeployDonorGlee private deployDonorGlee;
    ...
    function setUp() public {
        deployDonorGlee = new DeployDonorGlee();

        (donorGleeFund, donorGleeRaffle, helperConfig) = deployDonorGlee.run();
